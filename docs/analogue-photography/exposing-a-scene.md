...
1. **ISO** – How sensitive the film is to light
2. **Shutter speed** – How long the film is exposed
...
(If you're unsure what ISO means, see [Choosing and loading film](/analogue-photography/choosing-and-loading-film#understanding-film-iso).)
...
::: tip
Very small apertures (f/22, f/32) can cause [diffraction](/glossary#diffraction), reducing sharpness.
:::
...
- **Professional meters** – Measure [incident light](/glossary#incident-light) (light falling on your subject) for precision
...
1. Set aperture to **f/16** on sunny days
2. Set shutter speed to match your **ISO** (ISO 100 → 1/100s)
