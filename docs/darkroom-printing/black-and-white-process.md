...
Making a black & white darkroom print is one of the most rewarding processes in analogue photography. Using an [enlarger](/glossary#enlarger), you project your film [negative](/glossary#negative) onto light-sensitive [photographic paper](/glossary#photographic-paper), exposing it to create a [latent image](/glossary#latent-image). With care, patience, and a bit of trial and error, you can make a finished print by hand—revealing your image through light, chemistry, and craft.
...
The enlarger acts like a reversed camera. A light source inside the enlarger shines through your negative, and a lens focuses that image onto the paper below. This forms a latent image by exposing the [silver halides](/glossary#silver-halide-crystals) within the paper, which only becomes visible once developed in chemicals.
...
**[Developer](/glossary#developer)**: Brings out the latent image, converting the exposed silver halides into metallic silver.

- Time: 1–2 minutes
- Notes: Time varies based on temperature and paper type. Agitate gently and keep time consistent between prints.

**[Stop bath](/glossary#stop-bath)**: Halts development immediately.

- Time: 10–30 seconds
- Notes: A short rinse to neutralise the developer and prepare the paper for fixing.

**[Fixer](/glossary#fixer)**: Makes the image permanent and light-safe.
...
There are two main ways to control how much light reaches the paper: [aperture](/glossary#aperture) and [exposure time](/glossary#exposure-time).
...
To determine the right exposure, we use [test strips](/glossary#test-strip)—small sections of paper exposed at different times to find the best result. To make one:
...
You can control contrast either by selecting a specific type of photographic paper ([graded](/glossary#graded-paper)) or by using contrast filters with [multigrade](/glossary#multigrade-paper) paper.

### Graded paper

[Graded paper](/glossary#graded-paper) has a fixed contrast level, and each grade corresponds to a different level of contrast:
...
[Multigrade paper](/glossary#multigrade-paper) is more flexible. It responds to coloured contrast filters placed in the light path of your enlarger. These filters adjust the paper’s contrast without needing to switch to a different type of paper.
...
[Darkroom printing workflow diagram](/illustrations#darkroom-printing-workflow) {.caption}
