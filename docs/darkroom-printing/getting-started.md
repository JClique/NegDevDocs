...
Darkroom printing is the process of creating photographic prints using [light‑sensitive photographic paper](/glossary#photographic-paper), a chemical development process, and an [enlarger](/glossary#enlarger).
The process involves projecting an image from a film [negative](/glossary#negative) onto photographic paper, then processing it using chemical baths to reveal the final print.
...
The print is developed using three chemical baths: [developer](/glossary#developer), [stop bath](/glossary#stop-bath), and [fixer](/glossary#fixer).

**RA‑4 C‑type** prints are made by projecting colour negatives (typically [C‑41](/glossary#c-41) processed film) onto [RA‑4](/glossary#ra-4) colour paper.
This combination results in a full‑colour positive print.
The process requires a colour developer, followed by either separate bleach and fix baths or a combined [bleach‑fix (BLIX)](/glossary#bleach-fix-blix) solution.
...
In the darkroom, light exposes [silver halides](/glossary#silver-halide-crystals) within the [emulsion](/glossary#emulsion) layer of the paper, creating a [latent image](/glossary#latent-image) just like film.
