...
Once each negative has been photographed digitally it is transferred to a computer to be inverted.
...
Each method has trade-offs, so the best scanning method depends on your needs:
