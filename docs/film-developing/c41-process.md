...
The first step is to develop the film, turning the [latent image](/glossary#latent-image) into a visible negative.
...
Unlike black & white film, C-41 developer also contains [dye couplers](/glossary#dye-couplers), which form colour dyes around each metallic silver grain.
